...
const AcceptConnections: React.FC = () => {
  ...
  const applyFilters = async () => {
    ...
    await acceptFilterConnections(loggedInUser.connexikId, filters)
  }
  ...
  return (
    <div className="artdeco-card">
      <div
        ...
        <h1 className="t-18 t-black t-normal">Accept Connections</h1>
      </div>
      <div style={{ padding: "1.3rem", paddingTop: "0.3rem" }}>
        <div style={{}}>
          <input
            ...
            id="byAI"
            name="byAI"
            checked={filters.byAI}
            onChange={handleChange}
            style={{}}
          />
          <label htmlFor="byAI" style={{ display: "inline-block" }}>
            <div
              style={{
                marginTop: "-2%",
                fontSize: "small",
        ...
        <div style={{}}>
          <input
            ...
            style={{}}
          />
          <label htmlFor="byCompany" style={{ display: "inline-block" }}>
            <div
              style={{
                marginTop: "-2%",
                fontSize: "small",
              ...
              <span style={{ display: "block" }}>By Company</span>
              <span style={{ fontSize: "smaller", fontStyle: "italic" }}>
                (Matches current or past employers)
              </span>
            </div>
          </label>
        </div>
        ...
        <div style={{}}>
          <input
            ...
            style={{}}
          />
          <label htmlFor="bySchool" style={{ display: "inline-block" }}>
            <div
              style={{
                marginTop: "-2%",
                fontSize: "small",
              ...
              <span style={{ display: "block" }}>By School</span>
              <span style={{ fontSize: "smaller", fontStyle: "italic" }}>
                (Matches current or past institutes)
              </span>
            </div>
          </label>
        </div>
        ...
        <div style={{}}>
          <input
            ...
            style={{}}
          />
          <label htmlFor="byMutual" style={{ display: "inline-block" }}>
            <div
              style={{
                marginTop: "-2%",
                fontSize: "small",
              ...
              <span style={{ display: "block" }}>By Mutuals</span>
              <span style={{ fontSize: "smaller", fontStyle: "italic" }}>
                (Many shared connections)
              </span>
            </div>
          </label>
        </div>
        <div style={{}}>
          <input
            ...
            id="ignore"
            name="ignore"
            checked={filters.ignore}
            onChange={handleChange}
            style={{}}
          />
          <label htmlFor="ignore" style={{ display: "inline-block" }}>
            <div
              style={{
                marginTop: "-2%",
                fontSize: "small",
              ...
              <span style={{ display: "block" }}>Reject Irrelevant</span>
              <span style={{ fontSize: "smaller", fontStyle: "italic" }}>
                (Decline non-matching requests)
              </span>
            </div>
          </label>
        </div>
      ...
      <div
        className="text-align-center pv4"
        ...
        <button
          ...
          <span
            style={{ display: loggedInUser?.isScanned ? "none" : "inherit" }}>
            <svg
      ...
      {isModalOpen && (
        <div className="artdeco-modal-overlay artdeco-modal-overlay--is-top-layer">
          <div
            className="artdeco-modal artdeco-modal--layer-default"
            style={{ width: "38%", top: "25%" }}>
            <button
              ...
              <div className="pv2">
                ...
                <div
                  ...
                  <button
                    onClick={() => {
                      window.open(
                        `https://www.linkedin.com/in/${loggedInUser?.username}/?connexik-scan=true&connexik-redirect=accept`,
                        "_self"
                      )
                    }}
...
const waitForAsideElement = (): Promise<Element> => {
  return new Promise((resolve, reject) => {
    const container = document
      .querySelector(".application-outlet")
      .querySelector(".authentication-outlet")
    ...
    setTimeout(() => {
      observer.disconnect()
      reject(
        new Error(`Timeout: Element ".scaffold-layout__aside" not found within`)
      )
    }, 10000)
  })
}
